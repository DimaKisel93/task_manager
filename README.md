...
| ----------------- | ----------------------------------------- | ---------------------- |
| **Страницы**      | `TasksPage`, `TaskDetailsPage`            | React Router, MUI      |
| **UI компоненты** | `SearchField`, `SelectField`, `BaseModal` | MUI                    |
| **API слой**      | `tasksApi` (RTK Query)                    | RTK Query, JSON Server |
| **Формы**         | `TaskFormModal`                           | react-hook-form, zod   |
| **Утилиты**       | Хелперы для фильтров, валидации           | TypeScript             |

### 🎯 Ключевые архитектурные решения

| Компонент            | Решение                 | Почему                                         |
| -------------------- | ----------------------- | ---------------------------------------------- |
| **State Management** | RTK Query               | Автоматическое кэширование + инвалидация тегов |
| **Формы**            | react-hook-form + zod   | Производительность, типобезопасность           |
| **Стилизация**       | MUI (sx пропсы)         | Быстрая кастомизация, темизация                |
| **API (dev)**        | JSON Server (port 3001) | Моковый REST API с пагинацией                  |
| **Роутинг**          | React Router v6         | Клиентская маршрутизация                       |
| **Тестирование**     | Vitest + Storybook      | Unit тесты + визуальное тестирование           |
